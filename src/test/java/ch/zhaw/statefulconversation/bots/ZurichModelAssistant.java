...
class ZurichModelAssistant {
        ...
        void setUp() {
                ...
                Decision trigger = new StaticDecision(
                                ZurichModelAssistant.PROMPT_TRIGGER);
                Decision guard = new StaticDecision(
                                ZurichModelAssistant.PROMPT_GUARD);
                Action action = new StaticExtractionAction(ZurichModelAssistant.PROMPT_ACTION,
                                storage,
                                "summary");
                ...
                State state = new RegulatedState(regulationSystem,
                                ZurichModelAssistant.PROMPT_STATE,
                                "Mental Health Support Interaction",
                                ZurichModelAssistant.PROMPT_STATE_STARTER,
                                List.of(transition));
                Agent agent = new Agent("Mental Health Support Companion (Zurich Model Assistant)",
